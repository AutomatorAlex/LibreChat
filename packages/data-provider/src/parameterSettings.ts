...
const openAIParams: Record<string, SettingDefinition> = {
  ...
  repetition_penalty: {
    ...
    label: 'com_endpoint_repetition_penalty',
    labelCode: true,
    description: 'com_endpoint_openrouter_repetition_penalty',
    descriptionCode: true,
    type: 'number',
    default: 1.0,
    range: {
  ...
  min_p: {
    key: 'min_p',
    label: 'com_endpoint_min_p',
    labelCode: true,
    description: 'com_endpoint_openrouter_min_p',
    descriptionCode: true,
    type: 'number',
    default: 0.0,
    range: {
  ...
  top_a: {
    key: 'top_a',
    label: 'com_endpoint_top_a',
    labelCode: true,
    description: 'com_endpoint_openrouter_top_a',
    descriptionCode: true,
    type: 'number',
    default: 0.0,
    range: {
  ...
  seed: {
    ...
    labelCode: true,
    description: 'com_endpoint_openrouter_seed',
    descriptionCode: true,
    type: 'number',
    component: 'input',
    placeholder: 'com_endpoint_seed_placeholder',
    placeholderCode: true,
    optionType: 'model',
    columnSpan: 2,
  },
...
const openAICol2: SettingsConfiguration = [
  ...
  openAIParams.frequency_penalty,
  openAIParams.presence_penalty,
  openAIParams.repetition_penalty,
  openAIParams.min_p,
  openAIParams.top_a,
  openAIParams.seed,
  baseDefinitions.stop,
